...
namespace Devmoba.ToolManager.Migrations
{
    public partial class Add_all_table : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AppClientMachines",
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IPLan = table.Column<string>(maxLength: 15, nullable: false),
                    IPPublic = table.Column<string>(maxLength: 15, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppClientMachines", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExeFilePath = table.Column<string>(nullable: false),
                    ProcessId = table.Column<int>(nullable: false),
                    LastUpdate = table.Column<DateTime>(nullable: false),
                    SentMail = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTools", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScriptDependencyId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppDependencies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppDependencies_AppScripts_ScriptDependencyId",
                        column: x => x.ScriptDependencyId,
                        principalTable: "AppScripts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppDependencies_AppScripts_ScriptId",
                        column: x => x.ScriptId,
                        principalTable: "AppScripts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppClientMachines_UserId",
                table: "AppClientMachines",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppDependencies_ScriptDependencyId",
                table: "AppDependencies",
                column: "ScriptDependencyId");

            migrationBuilder.CreateIndex(
                name: "IX_AppDependencies_ScriptId",
                table: "AppDependencies",
                column: "ScriptId");
