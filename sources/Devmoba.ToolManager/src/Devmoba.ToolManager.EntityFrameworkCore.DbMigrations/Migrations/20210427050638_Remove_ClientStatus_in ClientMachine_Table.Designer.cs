...
{
    [DbContext(typeof(ToolManagerMigrationsDbContext))]
    [Migration("20210427050638_Remove_ClientStatus_in ClientMachine_Table")]
    partial class Remove_ClientStatus_inClientMachine_Table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Devmoba.ToolManager.ClientMachine", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("IPLan")
                        .IsRequired()
                        .HasColumnType("nvarchar(15)")
                        .HasMaxLength(15);

                    b.Property<string>("IPPublic")
                        .IsRequired()
                        .HasColumnType("nvarchar(15)")
                        .HasMaxLength(15);
                    ...
                    b.ToTable("AppClientMachines");
                });

            modelBuilder.Entity("Devmoba.ToolManager.Dependency", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("ScriptDependencyId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ScriptDependencyId");

                    b.HasIndex("ScriptId");

                    b.ToTable("AppDependencies");
                });

            modelBuilder.Entity("Devmoba.ToolManager.Script", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("AppScripts");
                });

            modelBuilder.Entity("Devmoba.ToolManager.Tool", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Devmoba.ToolManager.Dependency", b =>
                {
                    b.HasOne("Devmoba.ToolManager.Script", "ScriptDependency")
                        .WithMany("ScriptDependencies")
                        .HasForeignKey("ScriptDependencyId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Devmoba.ToolManager.Script", "Script")
            ...
            modelBuilder.Entity("Devmoba.ToolManager.Tool", b =>
                {
                    b.HasOne("Devmoba.ToolManager.ClientMachine", "ClientMachine")
                        .WithMany("Tools")
