...
namespace Devmoba.ToolManager.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ToolManagerDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ToolManagerEfCoreEntityExtensionMappings to extend the IdentityUser entity
